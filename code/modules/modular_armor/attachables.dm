...
/obj/item/armor_module/attachable/better_shoulder_lamp
	...
	desc = "Designed for mounting on the Xenonauten Combat Armor. Substantially increases the power output of the Xenonauten Combat Armor's mounted flashlight. Slows you down minorly."
...
/obj/item/armor_module/attachable/valkyrie_autodoc
	...
	desc = "Designed for mounting on the Xenonauten Combat Armor. Has a variety of chemicals it can inject, as well as automatically securing the bones and body of the wearer, to minimize the impact of broken bones or mangled limbs in the field. Will definitely impact mobility."
...
/obj/item/armor_module/attachable/fire_proof
	...
	desc = "Designed for mounting on the Xenonauten Combat Armor. Providing a near immunity to being bathed in flames, and amazing flame retardant qualities, this is every pyromaniacs' first stop to survival. Will impact mobility somewhat."
...
/obj/item/armor_module/attachable/tyr_extra_armor
	...
	desc = "Designed for mounting on the Xenonauten Combat Armor. A substantial amount of additional armor plating designed to fit inside some of the vulnerable portions of the Xenonauten Combat Armor conventional armor patterns. Will definitely impact mobility."
...
/obj/item/armor_module/attachable/tyr_extra_armor/mark1
	...
	desc = "Designed for mounting on the Xenonauten Combat Armor. A substantial amount of additional armor plating designed to fit inside some of the vulnerable portions of the Xenonauten Combat Armor conventional armor patterns. This older version has worse protection. Will definitely impact mobility."
...
/obj/item/armor_module/attachable/mimir_environment_protection
	...
	desc = "Designed for mounting on the Xenonauten Combat Armor. When activated, this system provides substantial resistance to environmental hazards, such as gases, and radiological exposure. This newer version provides resistance to acid. Best paired with the Mimir Environmental Helmet System and a gas mask. Will impact mobility." // Add the toggable thing to the description when you are done, okay? ~XS300
...
/obj/item/armor_module/attachable/mimir_environment_protection/mark1
	...
	desc = "Designed for mounting on the Xenonauten Combat Armor. When activated, this system provides substantial resistance to environmental hazards, such as gases and radiological exposure. This older version provides no protection to acid. Best paired with the Mimir Environmental Helmet System. Will impact mobility." // Add the toggable thing to the description when you are done, okay? ~XS300
	icon_state = "mod_biohazard_icon"
	item_state = "mod_biohazard"
	soft_armor = list("bio" = 0, "rad" = 10, "acid" = 0) //None, nada. This is made to protect you from gas and nothing else.
	slowdown = 0.2 //So it isn't literally 100% better than running stock Xenonauten.
	module_type = ARMOR_MODULE_TOGGLE

/obj/item/armor_module/attachable/hlin_explosive_armor
	name = "Hlin Explosive Compensation Module"
	desc = "Designed for mounting on the Xenonauten Combat Armor. Uses a complex set of armor plating and compensation to lessen the effect of explosions, at the cost of making the user slower."
...
/obj/item/armor_module/attachable/ballistic_armor
	...
	desc = "Designed for mounting on the Xenonauten Combat Armor. A substantial amount of additional armor plating designed to fit inside some of the vulnerable portions of the Xenonauten Combat Armor conventional armor patterns against bullets and nothing else. Will definitely impact mobility."
