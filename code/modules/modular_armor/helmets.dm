...
/obj/item/helmet_module/welding
	...
	desc = "Designed for mounting on a Xenonauten Helmet. When attached, this module can be flipped up or down to function as a welding mask."
...
/obj/item/helmet_module/attachable/mimir_environment_protection
	...
	desc = "Designed for mounting on a Xenonauten Helmet. When attached, this system provides substantial resistance to environmental hazards, such as gases, acidic elements, and radiological exposure. Best paired with the Mimir Environmental Resistance System. Will impact mobility when attached."
...
/obj/item/helmet_module/attachable/mimir_environment_protection/mark1 //gas protection
	...
	desc = "Designed for mounting on a Xenonauten Helmet. When attached, this system provides substantial resistance to environmental hazards, such as gases and radiological exposure. This older version has no acidic resistance. Best paired with the Mimir Environmental Resistance System and a gas mask."
	icon_state = "mimir_head_obj"
	item_state = "mimir_head"
	soft_armor = null
...
/obj/item/helmet_module/binoculars
	...
	desc = "Designed for mounting on a Xenonauten Helmet. When attached, can be flipped down to view into the distance."
...
/obj/item/helmet_module/antenna
	...
	desc = "Designed for mounting on a Xenonauten Helmet. When attached, this module is able to provide quick readuts of the users coordinates."
